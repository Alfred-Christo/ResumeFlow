...
import { Download, PlusCircle, Trash2, Eye, User, FileText, Briefcase, GraduationCap, Star, Folder } from 'lucide-react';
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="w-full md:w-1/2 space-y-8">
              <Card className="card-animate shadow-lg hover:shadow-2xl border-0 bg-white/90 dark:bg-card/90">
                <CardHeader className="pb-2">
                  <CardTitle className="text-4xl font-extrabold tracking-tight text-foreground flex items-center gap-3">
                ...
                <CardContent className="pt-0 pb-6">
                  <Accordion type="multiple" defaultValue={['contact', 'summary']} className="w-full rounded-2xl border border-muted/60 shadow-sm bg-muted/30 overflow-hidden">
                    <AccordionItem value="contact">
                      <AccordionTrigger className="text-xl font-semibold flex items-center gap-2 px-4 py-3 hover:bg-primary/10 focus:bg-primary/10 transition">
                        <User className="h-5 w-5 text-accent" /> Contact Information
                      </AccordionTrigger>
                      <AccordionContent className="space-y-4 p-4 bg-white/70 dark:bg-card/70 animate-fade-in">
                    ...
                    <AccordionItem value="summary">
                      <AccordionTrigger className="text-xl font-semibold flex items-center gap-2 px-4 py-3 hover:bg-primary/10 focus:bg-primary/10 transition">
                        <FileText className="h-5 w-5 text-accent" /> Professional Summary
                      </AccordionTrigger>
                      <AccordionContent className="space-y-4 p-4 bg-white/70 dark:bg-card/70 animate-fade-in">
                    ...
                    <AccordionItem value="skills">
                      <AccordionTrigger className="text-xl font-semibold flex items-center gap-2 px-4 py-3 hover:bg-primary/10 focus:bg-primary/10 transition">
                        <Star className="h-5 w-5 text-accent" /> Skills
                      </AccordionTrigger>
                      <AccordionContent className="space-y-4 p-4 bg-white/70 dark:bg-card/70 animate-fade-in">
                    ...
                    <AccordionItem value="projects">
                      <AccordionTrigger className="text-xl font-semibold flex items-center gap-2 px-4 py-3 hover:bg-primary/10 focus:bg-primary/10 transition">
                        <Folder className="h-5 w-5 text-accent" /> Projects (Optional)
                      </AccordionTrigger>
                      <AccordionContent className="space-y-4 p-4 bg-white/70 dark:bg-card/70 animate-fade-in">
                  ...
                  <div className="flex space-x-4">
                    <Button type="submit" size="lg" className="button-glow px-8 py-4 text-lg font-semibold">
                      <Download className="mr-2 h-5 w-5" /> Download Resume
                    </Button>
                    <Button type="button" variant="outline" size="lg" className="button-glow px-8 py-4 text-lg font-semibold" onClick={handlePreview}>
